...
client = openai.OpenAI(
    api_key="sk-f0ab3fca58abuabuabuabu0974549b3", # https://bailian.console.aliyun.com/?tab=model#/api-key
...
class Translate(BaseModel):
    """翻译文本"""
    origin_language: str = Field(description="原始语种")
    text: str = Field(description="待翻译文本")
    object_language: str = Field(description="目标语种")
result = ExtractionAgent(model_name = "qwen-plus").call('请帮我把good!翻译成中文', Translate)
print(result)
